...
![Hlavní rozhraní Artifex AI](docs/ui-overview.png)
...
![Nahrávání fotografií](docs/upload-screen.png)
...
![Panel AI Analýzy](docs/ai-analysis.png)
...
![Srovnání s Autopilot AI](docs/autopilot-comparison.png)
...
![Panel manuálních úprav](docs/manual-edits.png)
...
![Hromadné zpracování](docs/batch-processing.png)
